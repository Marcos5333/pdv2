	      ...
	      <div class="table-responsive">
	        <table class="table table-striped table-sm">
	          ...
	          <tbody>
	          	...
	          	$num = 0;
	          	$total = 0;
				// mysqli_fetch_assoc sempre retorna um array associaivo
	            ...
	            <tr>
	            	...
	            	<td>
	            		<button type="button" class="btn btn-danger btn-icon-split btn-sm" data-toggle="modal" data-idmesa="<?php echo  $id; ?>" data-idpedido="<?php echo  $rows_produtos['idpedido']; ?>" data-idproduto="<?php echo  $rows_produtos['produto']; ?>"data-target="#excluir">Excluir Item</button>
